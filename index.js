...
document.getElementById("aboutMeButton").addEventListener("click", function () {
  window.location.href = "https://leejihi.github.io/jihee/about/about";
});
...
$(document).ready(function () {
  ...
  $(".box4").on("mouseover", () => {
    $(".careerImg").attr({
      src: "./images/career-go.png",
      alt: "고용노동부",
    });
  });
  $(".box5").on("mouseover", () => {
    $(".careerImg").attr({
      src: "./images/career-kim.png",
      alt: "수협김 마음다애 어린이 도시락김",
    });
  });
  $(".box6").on("mouseover", () => {
    $(".careerImg").attr({
      src: "./images/career-seoul.png",
      alt: "서울예술대학",
    });
  });
});
